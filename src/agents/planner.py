...
class SubTask(BaseModel):
    ...
    files_to_modify: List[str] = Field(default_factory=list, description="需要修改的文件")
...
"""},
        ...
        messages = [Message(role=msg["role"], content=msg["content"]) for msg in full_prompt]
