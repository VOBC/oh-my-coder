...
> **DeepSeek 免费额度 · 11 家国产模型 · 18 个专业 Agent · 本地代码执行**

| 特性 | Oh My Coder | Claude Code | 其他工具 |
|------|:-----------:|:-----------:|:---------:|
| 模型支持 | 专注国产大模型，国内直连 | 依赖海外模型，需翻墙 | 参差不齐 |
| 中文优化 | 原生中文支持 | 英文为主 | 参差不齐 |
| 国内模型支持 | ✅ 11家厂商 | ❌ 仅 Claude | ⚠️ 有限支持 |
| 成本 | ✅ DeepSeek 免费额度 | ❌ Claude $20/月 | ⚠️ 按量付费 |
| 多 Agent 协作 | ✅ 18个专业Agent | ❌ 单一模型 | ⚠️ 有限支持 |
| 本地执行 | ✅ 代码本地运行 | ❌ 云端处理 | ⚠️ 部分支持 |
