...
- **oh-my-coder**：✅ **12家国产模型**（GLM-4.7-Flash、DeepSeek V4、通义千问、Kimi、豆包等），GLM-4.7-Flash **完全免费**
...
| 模型 | 免费额度 | 上下文 | 推荐理由 |
|------|----------|--------|----------|
| **DeepSeek V4.2** | 新用户赠送余额 | **128K** | 首选，代码能力强，输入 2 元/百万 tokens |
...
**Q: 支持本地部署吗？**
A: 支持。提供三种方式：
   1. 直接安装：`pip install -r requirements.txt && omc`
