...
> 多智能体 AI 编程助手
>
> 🤖 31 个专业 Agent  ·  12 家国产大模型  ·  GLM-4.7 完全免费
> 🌐 多 Agent 协作  ·  本地运行  ·  完全开源

**旁白（0:00 - 0:12）：**
> "oh-my-coder，一款基于国产大模型的多智能体 AI 编程助手。支持 GLM、DeepSeek、Qwen 等 12 家模型，GLM-4.7-Flash 完全免费。内置 31 个专业 Agent，覆盖代码探索、审查、调试、文档生成等全流程。"
