...
- [x] `models/kimi.py` -  Kimi(moonshot-v1，128K 上下文）
...
### 今日 Git Commits（共 10 个）

```
fedae52 docs: 更新 README 中的完整 Agent 列表（18个）
739f1a7 chore: 完善模型配置文档
f329299 chore: 项目优化和推广准备
d02dae9 docs: 更新项目进度和总结
ba31a57 feat: 添加5个大模型适配器
0f2338d release: v1.0.0 正式版本
b63e31d fix: 修复测试失败和代码警告
6c9fb16 feat: 添加API文档和Router性能优化
